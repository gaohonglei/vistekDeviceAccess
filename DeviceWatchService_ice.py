...
if 'PushStatusInfo' not in _M_Vistek.Device.__dict__:
    _M_Vistek.Device.PushStatusInfo = Ice.createTempClass()
    class PushStatusInfo(Ice.Object):
        def __init__(self, serviceID='', deviceID='', ip='', channel=0, status=False, pushTime='', errMsg=Ice.Unset):
            self.serviceID = serviceID
        ...
        def ice_ids(self, current=None):
            return ('::Ice::Object', '::Vistek::Device::PushStatusInfo')

        def ice_id(self, current=None):
            return '::Vistek::Device::PushStatusInfo'
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Vistek.Device._t_PushStatusInfo)

        __repr__ = __str__

    _M_Vistek.Device.PushStatusInfoPrx = Ice.createTempClass()
    class PushStatusInfoPrx(Ice.ObjectPrx):

        def checkedCast(proxy, facetOrCtx=None, _ctx=None):
            return _M_Vistek.Device.PushStatusInfoPrx.ice_checkedCast(proxy, '::Vistek::Device::PushStatusInfo', facetOrCtx, _ctx)
        checkedCast = staticmethod(checkedCast)

        def uncheckedCast(proxy, facet=None):
            return _M_Vistek.Device.PushStatusInfoPrx.ice_uncheckedCast(proxy, facet)
        uncheckedCast = staticmethod(uncheckedCast)
    ...
    _M_Vistek.Device._t_PushStatusInfoPrx = IcePy.defineProxy('::Vistek::Device::PushStatusInfo', PushStatusInfoPrx)

    _M_Vistek.Device._t_PushStatusInfo = IcePy.defineClass('::Vistek::Device::PushStatusInfo', PushStatusInfo, -1, (), False, False, None, (), (
        ('serviceID', (), IcePy._t_string, False, 0),
        ('deviceID', (), IcePy._t_string, False, 0),
        ('ip', (), IcePy._t_string, False, 0),
        ('channel', (), IcePy._t_int, False, 0),
        ('status', (), IcePy._t_bool, False, 0),
        ('pushTime', (), IcePy._t_string, False, 0),
        ('errMsg', (), IcePy._t_string, True, 0)
    ))
    PushStatusInfo._ice_type = _M_Vistek.Device._t_PushStatusInfo

    _M_Vistek.Device.PushStatusInfo = PushStatusInfo
    del PushStatusInfo

    _M_Vistek.Device.PushStatusInfoPrx = PushStatusInfoPrx
    del PushStatusInfoPrx

if 'PushStreamUriInfo' not in _M_Vistek.Device.__dict__:
    _M_Vistek.Device.PushStreamUriInfo = Ice.createTempClass()
    class PushStreamUriInfo(Ice.Object):
        def __init__(self, serviceID='', pushCount=0, pushContent='', pushTime=''):
            self.serviceID = serviceID
        ...
        def ice_ids(self, current=None):
            return ('::Ice::Object', '::Vistek::Device::PushStreamUriInfo')

        def ice_id(self, current=None):
            return '::Vistek::Device::PushStreamUriInfo'
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_Vistek.Device._t_PushStreamUriInfo)

        __repr__ = __str__

    _M_Vistek.Device.PushStreamUriInfoPrx = Ice.createTempClass()
    class PushStreamUriInfoPrx(Ice.ObjectPrx):

        def checkedCast(proxy, facetOrCtx=None, _ctx=None):
            return _M_Vistek.Device.PushStreamUriInfoPrx.ice_checkedCast(proxy, '::Vistek::Device::PushStreamUriInfo', facetOrCtx, _ctx)
        checkedCast = staticmethod(checkedCast)

        def uncheckedCast(proxy, facet=None):
            return _M_Vistek.Device.PushStreamUriInfoPrx.ice_uncheckedCast(proxy, facet)
        uncheckedCast = staticmethod(uncheckedCast)
    ...
    _M_Vistek.Device._t_PushStreamUriInfoPrx = IcePy.defineProxy('::Vistek::Device::PushStreamUriInfo', PushStreamUriInfoPrx)

    _M_Vistek.Device._t_PushStreamUriInfo = IcePy.defineClass('::Vistek::Device::PushStreamUriInfo', PushStreamUriInfo, -1, (), False, False, None, (), (
        ('serviceID', (), IcePy._t_string, False, 0),
        ('pushCount', (), IcePy._t_int, False, 0),
        ('pushContent', (), IcePy._t_string, False, 0),
        ('pushTime', (), IcePy._t_string, False, 0)
    ))
    PushStreamUriInfo._ice_type = _M_Vistek.Device._t_PushStreamUriInfo

    _M_Vistek.Device.PushStreamUriInfo = PushStreamUriInfo
    del PushStreamUriInfo

    _M_Vistek.Device.PushStreamUriInfoPrx = PushStreamUriInfoPrx
    del PushStreamUriInfoPrx
